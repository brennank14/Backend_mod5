...
StudentQuestion.create(student_id: 2, question_id: 1, grade: nil, feedback: nil, answer: nil)
StudentQuestion.create(student_id: 2, question_id: 2, grade: nil, feedback: nil, answer: nil)
StudentQuestion.create(student_id: 3, question_id: 1, grade: nil, feedback: nil, answer: nil)
StudentQuestion.create(student_id: 3, question_id: 2, grade: nil, feedback: nil, answer: nil)
StudentQuestion.create(student_id: 4, question_id: 3, grade: nil, feedback: nil, answer: nil)
StudentQuestion.create(student_id: 4, question_id: 4, grade: nil, feedback: nil, answer: nil)
StudentQuestion.create(student_id: 5, question_id: 3, grade: nil, feedback: nil, answer: nil)
StudentQuestion.create(student_id: 5, question_id: 4, grade: nil, feedback: nil, answer: nil)
StudentQuestion.create(student_id: 6, question_id: 3, grade: nil, feedback: nil, answer: nil)
StudentQuestion.create(student_id: 6, question_id: 4, grade: nil, feedback: nil, answer: nil)